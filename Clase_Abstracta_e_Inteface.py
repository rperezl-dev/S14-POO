...
#Clase abstracta: crear mezclas, abstractos y no abstractos
#cuando quiere que la clase no sea intanciada, solon heredada
#clase que sirva de clase para crear otras clases que hererdan a partir d
#la clase base.

#Cuando se crea una clase abstracta minimo se debe tener un metodo abstracto.
#Decorador: da ciertas funciones especiales al metodo.
